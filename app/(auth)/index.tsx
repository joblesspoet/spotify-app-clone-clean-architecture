...
const AuthHome = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Image
        source={require('@assets/images/auth_home_two.png')}
        style={{ position: 'absolute', zIndex: 120, right: 0, top: -9.87 }}
      />
      <Image
        source={require('@assets/images/auth_home_one.png')}
        style={{ position: 'absolute', zIndex: 130, right: 0, bottom: 0 }}
      />
        ...
        <View style={styles.buttonsContainer}>
          ...
          >
            <ButtonPrimary
              size="small"
              title="Register"
              onButtonPress={handleRegisterAction}
            />
      ...
      >
        <Image
          source={require('@assets/images/auth_character.png')}
          style={{}}
        />
      </View>
    </SafeAreaView>
